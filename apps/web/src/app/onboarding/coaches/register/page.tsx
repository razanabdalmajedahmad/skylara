...
function CoachRegisterForm() {
  ...
  const [form, setForm] = useState<Record<string, any>>({
    applicationType: 'COACH', disciplines: [], coachingTypes: [], languages: [],
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data = await apiPost('/onboarding/coaches', payload, { skipAuth: true });
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-4">Thank you for applying as a {form.applicationType.toLowerCase()}. We&apos;ll review your application and get back to you soon.</p>
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-r from-purple-700 via-indigo-700 to-blue-700 text-white p-8 lg:p-12">
        <div className="max-w-2xl mx-auto">
          ...
          <h1 className="text-3xl lg:text-4xl font-bold">Join as a Coach</h1>
          <p className="text-purple-200 mt-2">Apply to join the SkyLara coaching network. Share your skills with jumpers worldwide.</p>
        </div>
      </div>
